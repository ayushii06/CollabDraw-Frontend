  ...
  return (
     <div className="min-h-screen w-full relative overflow-hidden flex items-center justify-center">
      ...
      <div className="z-10 text-center -translate-y-20">
        ...
        <a 
          href="/"
          className="inline-flex items-center justify-center rounded-md bg-gray-800 px-6 py-3 text-sm font-medium text-primary hover:bg-gray-900/90 transition-colors"
        >
          Return Home
        </a>
      </div>
